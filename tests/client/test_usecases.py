...
@pytest.mark.asyncio
async def test_usecase_get_client_by_email_with_success(
    client_use_cases, mock_repository, mock_db, client_model, client_out
) -> None:
...
@pytest.mark.asyncio
async def test_usecase_update_client_with_success(
    client_use_cases, mock_repository, mock_db, client_in, client_model, client_out
) -> None:
    client_id = UUID("123e4567-e89b-12d3-a456-426614174000")
