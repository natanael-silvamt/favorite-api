...
@pytest.mark.asyncio
async def test_usecase_create_user_with_success(auth_use_cases, mock_repository, mock_db, user_in, user_model, user_out) -> None:
...
@pytest.mark.asyncio
async def test_usecase_authenticate_with_success(auth_use_cases, mock_repository, mock_db, user_model, user_out) -> None:
